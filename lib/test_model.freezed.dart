...
/// @nodoc
mixin _$TestModel {
  RealmTestModel get model => throw _privateConstructorUsedError;
...
class _$_TestModel implements _TestModel {
  const _$_TestModel({required this.model});

  @override
  final RealmTestModel model;
...
abstract class _TestModel implements TestModel {
  const factory _TestModel({required final RealmTestModel model}) =
      _$_TestModel;

  @override
  RealmTestModel get model;
  @override
  @JsonKey(ignore: true)
  _$$_TestModelCopyWith<_$_TestModel> get copyWith =>
      throw _privateConstructorUsedError;
